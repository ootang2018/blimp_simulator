...
from pets.misc.optimizers import RandomOptimizer, CEMOptimizer
...
class MPC(Controller):
    ...
    def __init__(self, params):
        ...
        self.train_in = np.array([]).reshape(0, self.dU + self.obs_preproc(np.zeros([1, self.dO])).shape[-1]) # why add self.dU?
